...
void RDOAbout::changeColor( const BYTE r, const BYTE g, const BYTE b )
{
	bgPixmap   = RGB( GetRValue(bgPixmap) + r, GetGValue(bgPixmap) + g, GetBValue(bgPixmap) + b );
	fgCaption  = RGB( GetRValue(fgCaption) + r, GetGValue(fgCaption) + g, GetBValue(fgCaption) + b );
	bgCaption  = RGB( GetRValue(bgCaption) + r, GetGValue(bgCaption) + g, GetBValue(bgCaption) + b );
	fgInfo     = RGB( GetRValue(fgInfo) + r, GetGValue(fgInfo) + g, GetBValue(fgInfo) + b );
	bgInfo     = RGB( GetRValue(bgInfo) + r, GetGValue(bgInfo) + g, GetBValue(bgInfo) + b );
	fgLink     = RGB( GetRValue(fgLink) + r, GetGValue(fgLink) + g, GetBValue(fgLink) + b );
