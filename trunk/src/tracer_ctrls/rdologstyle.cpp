...
{
	regParam += "_%s";
	foregroundColor = AfxGetApp()->GetProfileInt( regPath.c_str(), format( regParam.c_str(), "foregroundColor" ).c_str(), foregroundColor );
	backgroundColor = AfxGetApp()->GetProfileInt( regPath.c_str(), format( regParam.c_str(), "backgroundColor" ).c_str(), backgroundColor );
}

void RDOLogColorPair::save( string regPath, string regParam ) const
{
	regParam += "_%s";
	AfxGetApp()->WriteProfileInt( regPath.c_str(), format( regParam.c_str(), "foregroundColor" ).c_str(), foregroundColor );
	AfxGetApp()->WriteProfileInt( regPath.c_str(), format( regParam.c_str(), "backgroundColor" ).c_str(), backgroundColor );
}
