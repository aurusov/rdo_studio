...
void CChatChildView::addStringToViewer( const std::string& userName, const std::string& str, CChatStringType type, const std::string& toUserName )
{
	CChatString* cstr = new CChatString( userName, str, type, toUserName );
