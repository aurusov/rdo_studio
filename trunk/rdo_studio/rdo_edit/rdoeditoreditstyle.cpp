...
// ---------- RDOEditorEditTheme
// ----------------------------------------------------------------------------
RDOEditorEditTheme::RDOEditorEditTheme(): RDOEditorSciEditTheme()
{
...
string RDOEditorEditTheme::styleFGColorToHEX( const int styleType ) const
{
	...
	return RDOEditorSciEditTheme::styleFGColorToHEX( styleType );
}
