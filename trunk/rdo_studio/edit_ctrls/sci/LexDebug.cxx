...
static void ColouriseDebugDoc( unsigned int startPos, int length, int initStyle, WordList *keywordlists[], Accessor &styler )
{
...
LexerModule lmDebug( SCLEX_DEBUG, ColouriseDebugDoc, "debug" );
