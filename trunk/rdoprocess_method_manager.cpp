...
BEGIN_MESSAGE_MAP( RPMethodNewDlg, CDialog )
	...
	//}}AFX_MSG_MAP
	ON_NOTIFY(LVN_ITEMCHANGED, IDC_METHOD_LIST, &RPMethodNewDlg::OnMethodListItemСhanged)
...
void RPMethodNewDlg::OnMethodListItemСhanged( NMHDR *pNMHDR, LRESULT *pResult )
{
