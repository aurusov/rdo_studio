...
MACRO(RDO_BISON_TARGET FILE_TYPE)
	...
	SET(CPP_OUTPUT_FILE ${CMAKE_CURRENT_BINARY_DIR}/rdogram${FILE_TYPE}.cpp)
	SET(BISON_${FILE_TYPE}_OUTPUTS ${CPP_OUTPUT_FILE})
	SET(OUTPUT_FILE ${CPP_OUTPUT_FILE})

	LIST(APPEND OUTPUT_FILE ${CMAKE_CURRENT_BINARY_DIR}/rdogram${FILE_TYPE}.dot)
	LIST(APPEND OUTPUT_FILE ${CMAKE_CURRENT_BINARY_DIR}/rdogram${FILE_TYPE}.output)
