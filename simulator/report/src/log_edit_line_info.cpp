...
LogEditLineInfo::LogEditLineInfo(const std::string& text, rdo::FileType file, std::size_t line, std::size_t pos, Type type)
...
LogEditLineInfo::LogEditLineInfo(const std::string& message)
    : FileMessage(message, rdo::FileType::PAT, 0, 0)
    , m_posInLog(0)
