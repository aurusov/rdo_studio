...
//Расчет количества вагонов по весу. Кстати, используй функцию Int()
...
заявка
	...
	Convert_rule
		if (заявка.остаток_в_заявке > (60 - формируемый_состав.текущее_количество_вагонов))
			буфер = 60 - формируемый_состав.текущее_количество_вагонов;
		else
...
//Порверка, заполнен ли состав (для этого заявка не нужна!)
$Pattern Образец_расп: rule
$Relevant_resources
	формируемый_состав: формируемые_составы Keep
$Body
формируемый_состав
...
//Порверка, вся ли зявка списана (для этого состав не нужен!)
$Pattern Образец_расп: rule
$Relevant_resources
	заявка            : заявки              Keep
$Body
