...
заявка    
	Choice from заявка.состояние = распределение_вагонов and заявка.маршрут = формируемый_состав.маршрут
			and заявка.номер_заявки = формируемый_состав.номер_распределяемой_заявки
	Convert_rule
		состояние = служебное_состояние_1;
$End 
...
заявка    
	...
	флаг_заявки = 1;
		...
		{
			остаток_в_заявке -= вагоны_в_составе - формируемый_состав.текущее_количество_вагонов;
		}
		else 
		{
			остаток_в_заявке = 0; 
...
формируемый_состав    
	...
	Convert_rule
		...
		if ((вагоны_в_составе - формируемый_состав.текущее_количество_вагонов) <= заявка.остаток_в_заявке) 
			текущее_количество_вагонов = вагоны_в_составе;
		else
