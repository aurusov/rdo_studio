$Pattern Образец_прихода_заявок : irregular_event //блабла 
$Relevant_resources
...
заявка
	...
	Convert_rule
		...
		остаток_в_заявке = количество_вагонов_в_заявке; //здесь этому самое место!
$End

$Pattern Образец_назначение_нового_номера_состава : rule
$Relevant_resources
...
$Pattern Образец_подготовки_формируемого_состава_к_обработке_текущей_заявки1: rule
$Relevant_resources
	заявка             : заявки              Keep  
	формируемый_состав : формируемые_составы Keep 
$Body
заявка 
	Choice from заявка.состояние == рассчитана
	Convert_rule
		буфер = заявка.количество_вагонов_в_заявке;
		состояние = распределение_вагонов;
формируемый_состав
	Choice from формируемый_состав.маршрут == заявка.маршрут 
			and флаг_формируемого_состава == 0
			and (формируемый_состав.состояние == пустой or формируемый_состав.состояние == полупустой)
	Convert_rule
		состояние = распределение_вагонов;
$End

$Pattern Образец_подготовки_формируемого_состава_к_обработке_текущей_заявки2: rule
$Relevant_resources
	заявка             : заявки              Keep  
	формируемый_состав : формируемые_составы Keep 
$Body
заявка 
	Choice from заявка.состояние == остались_нераспределенные_вагоны 
	Convert_rule
