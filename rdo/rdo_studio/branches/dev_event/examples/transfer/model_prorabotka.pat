...
_формируемый_состав
	Choice from _формируемый_состав.состояние == распределение_вагонов
			and _формируемый_состав.полный    == false
...
$Body
_формируемый_состав
	Choice from _формируемый_состав.состояние == списание_закончено
	Convert_rule
...
$Body
_формируемый_состав
	Choice from _формируемый_состав.состояние == заполнен and полный == true
	Convert_rule
...
$Body
_формируемый_состав
	Choice from _формируемый_состав.состояние == назначение_нового_номера
	Convert_rule
