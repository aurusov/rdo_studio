...
irregular_event?0 event?0 Keep?0 keyboard?0 line?0 list?0 longint?0 Model_name?0 Monitor?0 NO?0 \
...
with_min?0 YES?0 Seed?0 —ËÒÚÂÏÌÓÂ_‚ÂÏˇ?0 not?0 if?0 else?0 result?0 ruler?0 space?0 string?0 bool?0 true?0 false?0 \
