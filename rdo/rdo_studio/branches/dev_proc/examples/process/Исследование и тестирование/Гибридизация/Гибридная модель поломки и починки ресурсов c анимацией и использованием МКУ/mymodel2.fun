...
$Function новое_состояние_робота : 
						such_as Роботы.Состояние = Свободен
$Type = algorithmic
$Parameters
	текущее_состояние : such_as Роботы.Состояние
$Body
	Calculate_if текущее_состояние = Свободен 
	or текущее_состояние = Занят
		новое_состояние_робота = Сломан
	Calculate_if текущее_состояние = Сломан 		
		новое_состояние_робота = Свободен
$End

$Function новое_состояние : such_as Станки.Состояние
$Type = algorithmic
$Parameters
