...
inline RDOValue::RDOValue(CREF(rsint) value)
	...
	, m_value(value)
	, m_type (rdo::Factory<RDOType__int>::create().object_parent_cast<RDOType>())
{}
...
inline RDOValue::RDOValue(CREF(double) value)
	: RDOParserSrcInfo(rdoRuntime::RDOValue(value).getAsString())
	, m_value(value )
	, m_type (rdo::Factory<RDOType__real>::create().object_parent_cast<RDOType>())
{}

inline RDOValue::RDOValue(CREF(tstring) value)
	: RDOParserSrcInfo(value   )
	, m_value         (value   )
	, m_type          (rdo::Factory<RDOType__string>::create().object_parent_cast<RDOType>())
{}
