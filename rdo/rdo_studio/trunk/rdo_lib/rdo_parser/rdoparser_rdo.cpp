...
{
	PTR(RDORTPIntParamType)  intType  = new RDORTPIntParamType(m_parser, new RDORTPIntDiap(m_parser), new RDORTPDefVal(m_parser));
	PTR(RDORTPRealParamType) realType = new RDORTPRealParamType(m_parser, new RDORTPRealDiap(m_parser), new RDORTPDefVal(m_parser));
