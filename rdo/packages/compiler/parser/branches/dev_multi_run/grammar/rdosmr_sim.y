...
/*!
  ...
  \date      20.02.2003
  \brief     РЎРёРЅС‚Р°РєСЃРёСЃ РѕРїРёСЃР°РЅРёСЏ РёРЅС„РѕСЂРјР°С†РёРё Рѕ РїСЂРѕРіРѕРЅРµ (СЂРµР¶РёРј Р°РЅРёРјР°С†РёРё, РёРЅРёС†РёР°Р»РёР·Р°С†РёСЏ СЃРїРёСЃРєР° СЃРѕР±С‹С‚РёР№, С‚РµСЂРјРёРЅР°Р»СЊРЅРѕРµ СѓСЃР»РѕРІРёРµ Рё С‚.Рґ.)
  \indent    4T
*/
...
smr_cond
	...
	| smr_cond RDO_IDENTIF '.' RDO_Planning '(' arithm_list ')'
	{
		...
		if (!pEvent)
		{
			PARSER->error().error(@2, rdo::format("РџРѕРїС‹С‚РєР° Р·Р°РїР»Р°РЅРёСЂРѕРІР°С‚СЊ РЅРµРёР·РІРµСЃС‚РЅРѕРµ СЃРѕР±С‹С‚РёРµ: %s", eventName.c_str()));
		}

		ArithmContainer::Container::const_iterator arithmIt = pArithmList->getContainer().begin();
		if (arithmIt == pArithmList->getContainer().end())
		{
			PARSER->error().error(@1, rdo::format("РќРµ СѓРєР°Р·Р°РЅРѕ РІСЂРµРјСЏ РїР»Р°РЅРёСЂРѕРІР°РЅРёСЏ СЃРѕР±С‹С‚РёСЏ: %s", eventName.c_str()));
		}
		...
		rdo::runtime::LPRDOCalcEventPlan pEventPlan = rdo::Factory<rdo::runtime::RDOCalcEventPlan>::create(pCalcTime);
		pEventPlan->setSrcInfo(RDOParserSrcInfo(@1, @7, rdo::format("РџР»Р°РЅРёСЂРѕРІР°РЅРёРµ СЃРѕР±С‹С‚РёСЏ %s РІ РјРѕРјРµРЅС‚ РІСЂРµРјРµРЅРё %s", eventName.c_str(), pCalcTime->srcInfo().src_text().c_str())));
		ASSERT(pEventPlan);
		pEvent->setParamList(pParamList);
		pEventPlan->setEvent(pBaseOperation);
		pEvent->setInitCalc(pEventPlan);
	...
	| smr_cond RDO_Show_mode '=' error
	{
		PARSER->error().error(@3, @4, "РћР¶РёРґР°РµС‚СЃСЏ СЂРµР¶РёРј Р°РЅРёРјР°С†РёРё");
	}
	| smr_cond RDO_Show_mode error
	{
		PARSER->error().error(@2, "РћР¶РёРґР°РµС‚СЃСЏ '='");
	}
	| smr_cond RDO_Frame_number '=' RDO_INT_CONST
	{
		LPRDOSMR pSMR = PARSER->getSMR();
	...
	| smr_cond RDO_Frame_number '=' error
	{
		PARSER->error().error(@3, @4, "РћР¶РёРґР°РµС‚СЃСЏ РЅР°С‡Р°Р»СЊРЅС‹Р№ РЅРѕРјРµСЂ РєР°РґСЂР°");
	}
	| smr_cond RDO_Frame_number error
	{
		PARSER->error().error(@2, "РћР¶РёРґР°РµС‚СЃСЏ '='");
	...
	| smr_cond RDO_Show_rate '=' error
	{
		PARSER->error().error(@3, @4, "РћР¶РёРґР°РµС‚СЃСЏ РјР°СЃС€С‚Р°Р±РЅС‹Р№ РєРѕСЌС„С„РёС†РёРµРЅС‚");
	}
	| smr_cond RDO_Show_rate error
	{
		PARSER->error().error(@2, "РћР¶РёРґР°РµС‚СЃСЏ '='");
	...
	| smr_cond RDO_Run_StartTime '=' error
	{
		PARSER->error().error(@3, @4, "РћР¶РёРґР°РµС‚СЃСЏ РЅР°С‡Р°Р»СЊРЅРѕРµ РјРѕРґРµР»СЊРЅРѕРµ РІСЂРµРјСЏ");
	}
	| smr_cond RDO_Run_StartTime error
	{
		PARSER->error().error(@2, "РћР¶РёРґР°РµС‚СЃСЏ '='");
	...
	| smr_cond RDO_Trace_StartTime '=' error
	{
		PARSER->error().error(@3, @4, "РћР¶РёРґР°РµС‚СЃСЏ РЅР°С‡Р°Р»СЊРЅРѕРµ РІСЂРµРјСЏ С‚СЂР°СЃСЃРёСЂРѕРІРєРё");
	}
	| smr_cond RDO_Trace_StartTime error
	{
		PARSER->error().error(@2, "РћР¶РёРґР°РµС‚СЃСЏ '='");
	...
	| smr_cond RDO_Trace_EndTime '=' error
	{
		PARSER->error().error(@3, @4, "РћР¶РёРґР°РµС‚СЃСЏ РєРѕРЅРµС‡РЅРѕРµ РІСЂРµРјСЏ С‚СЂР°СЃСЃРёСЂРѕРІРєРё");
	}
	| smr_cond RDO_Trace_EndTime error
	{
		PARSER->error().error(@2, "РћР¶РёРґР°РµС‚СЃСЏ '='");
	...
	| smr_cond RDO_Terminate_if error
	{
		PARSER->error().error(@2, @3, "РћС€РёР±РєР° Р»РѕРіРёС‡РµСЃРєРѕРіРѕ РІС‹СЂР°Р¶РµРЅРёСЏ РІ С‚РµСЂРјРёРЅР°Р»СЊРЅРѕРј СѓСЃР»РѕРІРёРё");
	}
	| smr_cond RDO_Break_point RDO_IDENTIF fun_logic
	{
		LPRDOSMR pSMR = PARSER->getSMR();
	...
	| smr_cond RDO_Break_point RDO_IDENTIF error
	{
		PARSER->error().error(@4, "РћС€РёР±РєР° Р»РѕРіРёС‡РµСЃРєРѕРіРѕ РІС‹СЂР°Р¶РµРЅРёСЏ РІ С‚РѕС‡РєРµ РѕСЃС‚Р°РЅРѕРІР°");
	}
	| smr_cond RDO_Break_point error
	{
		PARSER->error().error(@2, @3, "РћР¶РёРґР°РµС‚СЃСЏ РёРјСЏ С‚РѕС‡РєРё РѕСЃС‚Р°РЅРѕРІР°");
	}
	| smr_cond RDO_IDENTIF '=' fun_arithm
	{
		LPRDOFUNArithm pArithm = PARSER->stack().pop<RDOFUNArithm>($4);
	...
	| smr_cond RDO_IDENTIF '=' error
	{
		PARSER->error().error(@3, @4, "РћС€РёР±РєР° РІ Р°СЂРёС„РјРµС‚РёС‡РµСЃРєРѕРј РІС‹СЂР°Р¶РµРЅРёРё");
	}
	| smr_cond RDO_IDENTIF error
	{
		PARSER->error().error(@2, "РћР¶РёРґР°РµС‚СЃСЏ '='");
	...
	| smr_cond RDO_IDENTIF '.' RDO_IDENTIF '=' error
	{
		PARSER->error().error(@5, @6, "РћС€РёР±РєР° РІ Р°СЂРёС„РјРµС‚РёС‡РµСЃРєРѕРј РІС‹СЂР°Р¶РµРЅРёРё");
	}
	| smr_cond RDO_IDENTIF '.' RDO_IDENTIF error
	{
		PARSER->error().error(@4, "РћР¶РёРґР°РµС‚СЃСЏ '='");
	}
	| smr_cond RDO_IDENTIF '.' error
	{
		tstring name = PARSER->stack().pop<RDOValue>($2)->value().getIdentificator();
		...
		if (pResource)
		{
			PARSER->error().error(@3, @4, "РћР¶РёРґР°РµС‚СЃСЏ РїР°СЂР°РјРµС‚СЂ");
		}
		else
		{
			LPRDOFUNSequence pSequence = PARSER->findFUNSequence(name);
			if (pSequence)
			{
				PARSER->error().error(@3, @4, "РћР¶РёРґР°РµС‚СЃСЏ РєР»СЋС‡РµРІРѕРµ СЃР»РѕРІРѕ Seed");
			}
			else
			{
				PARSER->error().error(@2, "РќРµРёР·РІРµСЃС‚РЅС‹Р№ РїР°СЂР°РјРµС‚СЂ РёР»Рё РїРѕСЃР»РµРґРѕРІР°С‚РµР»СЊРЅРѕСЃС‚СЊ");
			}
		}
	}
	| smr_cond RDO_IDENTIF '.' RDO_Seed '=' RDO_INT_CONST
	...
	| smr_cond RDO_IDENTIF '.' RDO_Seed '=' error
	{
		PARSER->error().error(@5, @6, "РћР¶РёРґР°РµС‚СЃСЏ Р±Р°Р·Р° РіРµРЅРµСЂР°С‚РѕСЂР°");
	}
	| smr_cond RDO_IDENTIF '.' RDO_Seed error
	{
		PARSER->error().error(@4, "РћР¶РёРґР°РµС‚СЃСЏ '='");
	...
	| smr_cond error
	{
		PARSER->error().error(@2, "РќРµРёР·РІРµСЃС‚РЅР°СЏ РѕС€РёР±РєР°");
	}
	;
...
param_array_value
	...
	| '[' array_item error
	{
		PARSER->error().error(@2, "РњР°СЃСЃРёРІ РґРѕР»Р¶РµРЅ Р·Р°РєСЂС‹РІР°С‚СЊСЃСЏ СЃРєРѕР±РєРѕР№");
	}
	;
...
array_item
	...
	| array_item param_value
	{
		...
		pArrayValue->insertItem(pValue);
		$$ = PARSER->stack().push(pArrayValue);
		PARSER->error().warning(@1, rdo::format("РџСЂРѕРїСѓС‰РµРЅР° Р·Р°РїСЏС‚Р°СЏ РїРµСЂРµРґ: %s", pValue->value().getAsString().c_str()));
	}
	;
...
param_value_default
	...
	| '=' error
	{
		...
		if (src_info.src_pos().point())
		{
			PARSER->error().error(src_info, "РќРµ СѓРєР°Р·Р°РЅРѕ Р·РЅР°С‡РµРЅРёРµ РїРѕ СѓРјРѕР»С‡Р°РЅРёСЋ");
		}
		else
		{
			PARSER->error().error(src_info, "РќРµРІРµСЂРЅРѕРµ Р·РЅР°С‡РµРЅРёРµ РїРѕ СѓРјРѕР»С‡Р°РЅРёСЋ");
		}
	}
	;
...
fun_logic
	...
	| '[' fun_logic error
	{
		PARSER->error().error(@2, "РћР¶РёРґР°РµС‚СЃСЏ Р·Р°РєСЂС‹РІР°СЋС‰Р°СЏСЃСЏ СЃРєРѕР±РєР°");
	}
	| '(' fun_logic error
	{
		PARSER->error().error(@2, "РћР¶РёРґР°РµС‚СЃСЏ Р·Р°РєСЂС‹РІР°СЋС‰Р°СЏСЃСЏ СЃРєРѕР±РєР°");
...
fun_arithm
	...
	| RDO_IDENTIF '.' RDO_Size
	{
		...
		{
			PARSER->error().error(@1, rdo::format("'%s' РЅРµ СЏРІР»СЏРµС‚СЃСЏ РјР°СЃСЃРёРІРѕРј.", pValue->value().getIdentificator().c_str()));
		}
...
fun_arithm_func_call
	...
	| RDO_IDENTIF '(' error
	{
		PARSER->error().error(@3, "РћС€РёР±РєР° РІ РїР°СЂР°РјРµС‚СЂР°С… С„СѓРЅРєС†РёРё");
	}
	;
...
arithm_list_body
	...
	| arithm_list_body ',' error
	{
		PARSER->error().error(@3, "РћС€РёР±РєР° РІ Р°СЂРёС„РјРµС‚РёС‡РµСЃРєРѕРј РІС‹СЂР°Р¶РµРЅРёРё");
	}
	;
...
fun_group_header
	...
	| fun_group_keyword '(' error
	{
		PARSER->error().error(@3, "РћР¶РёРґР°РµС‚СЃСЏ РёРјСЏ С‚РёРїР°");
	}
	| fun_group_keyword error
	{
		PARSER->error().error(@1, "РџРѕСЃР»Рµ РёРјРµРЅРё С„СѓРЅРєС†РёРё РѕР¶РёРґР°РµС‚СЃСЏ РѕРєС‚СЂС‹РІР°СЋС‰Р°СЏСЃСЏ СЃРєРѕР±РєР°");
	}
	;
...
fun_group
	...
	| fun_group_header error
	{
		PARSER->error().error(@1, @2, "РћС€РёР±РєР° РІ Р»РѕРіРёС‡РµСЃРєРѕРј РІС‹СЂР°Р¶РµРЅРёРё");
	}
	;
...
fun_select_header
	...
	| RDO_Select error
	{
		PARSER->error().error(@1, "РћР¶РёРґР°РµС‚СЃСЏ РѕРєС‚СЂС‹РІР°СЋС‰Р°СЏСЃСЏ СЃРєРѕР±РєР°");
	}
	;
...
fun_select_logic
	...
	| fun_select_body '.' fun_select_keyword '(' error
	{
		PARSER->error().error(@4, @5, "РћС€РёР±РєР° РІ Р»РѕРіРёС‡РµСЃРєРѕРј РІС‹СЂР°Р¶РµРЅРёРё");
	}
	| fun_select_body '.' fun_select_keyword error
	{
		PARSER->error().error(@3, "РћР¶РёРґР°РµС‚СЃСЏ РѕРєС‚СЂС‹РІР°СЋС‰Р°СЏСЃСЏ СЃРєРѕР±РєР°");
	}
	| fun_select_body '.' RDO_Empty '(' ')'
	{
		LPRDOFUNSelect pSelect = PARSER->stack().pop<RDOFUNSelect>($1);
	...
	| fun_select_body '.' RDO_Empty '(' error
	{
		PARSER->error().error(@4, "РћР¶РёРґР°РµС‚СЃСЏ Р·Р°РєСЂС‹РІР°СЋС‰Р°СЏСЃСЏ СЃРєРѕР±РєР°");
	}
	| fun_select_body '.' RDO_Empty error
	{
		PARSER->error().error(@3, "РћР¶РёРґР°РµС‚СЃСЏ РѕРєС‚СЂС‹РІР°СЋС‰Р°СЏСЃСЏ СЃРєРѕР±РєР°");
	...
	| fun_select_body '.' error
	{
		PARSER->error().error(@2, @3, "РћР¶РёРґР°РµС‚СЃСЏ РјРµС‚РѕРґ СЃРїРёСЃРєР° СЂРµСЃСѓСЂСЃРѕРІ");
	}
	| fun_select_body error
	{
		PARSER->error().error(@1, "РћР¶РёРґР°РµС‚СЃСЏ '.' (С‚РѕС‡РєР°) РґР»СЏ РІС‹Р·РѕРІР° РјРµС‚РѕРґР° СЃРїРёСЃРєР° СЂРµСЃСѓСЂСЃРѕРІ");
	}
	;
