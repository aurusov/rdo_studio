...
public:
	...
	*/
	...
	void addResType(ruint number, CREF(LPIResourceType) pResType);
	CREF(LPIResourceType) getResType(ruint number) const;
...
private:
	...
	typedef  std::vector<LPIResourceType>  ResourceTypeList;
