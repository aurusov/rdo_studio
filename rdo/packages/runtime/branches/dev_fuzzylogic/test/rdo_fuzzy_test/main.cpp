...
//	typedef std::pair<FuzzySet::FuzzySetDefinition::iterator, rbool> InsertResult;
//
//	InsertResult insVal1 = pSetDefinition.insert(FuzzySet::FuzzySetDefinition::value_type(5, 0.5));
//	BOOST_CHECK(insVal1.second);
//
//	InsertResult insVal2 = pSetDefinition.insert(std::pair<RDOValue,double>(1,0.1));
//	BOOST_CHECK(insVal2.second);
//
//	InsertResult insVal3 = pSetDefinition.insert(std::pair<RDOValue,double>(2,0.2));
//	BOOST_CHECK(insVal3.second);
//
//	InsertResult insVal4 = pSetDefinition.insert(std::pair<RDOValue,double>(3,1.0));
//	BOOST_CHECK(insVal4.second);
//
//	InsertResult insVal5 = pSetDefinition.insert(std::pair<RDOValue,double>(6,0.4));
//	BOOST_CHECK(insVal5.second);
//
//	InsertResult insVal6 = pSetDefinition.insert(std::pair<RDOValue,double>(7,0.2));
//	BOOST_CHECK(insVal6.second);
//
//	InsertResult insVal7 = pSetDefinition.insert(std::pair<RDOValue,double>(9,0.1));
//	BOOST_CHECK(insVal7.second);
//
//	InsertResult insVal8 = pSetDefinition.insert(std::pair<RDOValue,double>(9,0.5));
