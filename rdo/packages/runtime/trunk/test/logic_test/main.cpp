/*!
  ...
  \authors   œÓÈ‰‡ÍÓ‚ ≈‚„ÂÌËÈ (lord.tiran@gmail.com)
  \date      28.09.2009
  \brief     “ÂÒÚ ÎÓ„ËÍ
  \indent    4T
*/
...
public:
	...
	{
		Order::sort(m_Òontainer);

		data_vector check_data;

		Container::CIterator endIt = m_Òontainer.end();
		for(Container::Iterator it = m_Òontainer.begin() ;it != endIt; ++it)
		{
