...
// --------------------------------------------------------------------------------
dptrtp_main:
	| dptrtp_main RDO_Decision_point error RDO_End {@1} /* Ð·Ð°Ð³Ð»ÑƒÑˆÐºÐ° Ð´Ð»Ñ $Decision_point */
	| dptrtp_main RDO_Activities     error RDO_End      /* Ð·Ð°Ð³Ð»ÑƒÑˆÐºÐ° Ð´Ð»Ñ $Activities     */
	| dptrtp_main RDO_Process        error RDO_End      /* Ð·Ð°Ð³Ð»ÑƒÑˆÐºÐ° Ð´Ð»Ñ $Process        */
	;
...
// --------------------------------------------------------------------------------
dptrtp_main:
	| dptrtp_main RDO_Decision_point error RDO_End {@1} /* çàãëóøêà äëÿ $Decision_point */
	| dptrtp_main RDO_Activities     error RDO_End      /* çàãëóøêà äëÿ $Activities     */
	| dptrtp_main RDO_Process        error RDO_End      /* çàãëóøêà äëÿ $Process        */
	;
