...
enum DefinitionKind { dk_none, dk_all, dk_Attribute, dk_Constant, dk_Exception, dk_Interface, dk_Module, dk_Operation, dk_Typedef, dk_Alias, dk_Struct, dk_Union, dk_Enum, dk_Primitive, dk_String, dk_Sequence, dk_Array, dk_Repository, dk_Wstring, dk_Fixed, dk_Value, dk_ValueBox, dk_Member, dk_Native, dk_AbstractInterface /*, __max_DefinitionKind=0xffffffff */ };
...
public:
  ...
  virtual void type_def(IDLType_ptr _v) = 0;
...
public:
  StructMemberSeq* members();
  void members(const StructMemberSeq& _v);
...
public:
  ...
  virtual void members(const StructMemberSeq& _v) = 0;
...
public:
  ...
  void discriminator_type_def(IDLType_ptr _v);
  UnionMemberSeq* members();
  void members(const UnionMemberSeq& _v);
...
public:
  ...
  virtual void discriminator_type_def(IDLType_ptr _v) = 0;
  virtual UnionMemberSeq* members() = 0;
  virtual void members(const UnionMemberSeq& _v) = 0;
...
public:
  ...
  void members(const EnumMemberSeq& _v);
...
public:
  ...
  virtual void members(const EnumMemberSeq& _v) = 0;
...
public:
  ...
  void original_type_def(IDLType_ptr _v);
...
public:
  ...
  virtual void original_type_def(IDLType_ptr _v) = 0;
...
public:
  ...
  void element_type_def(IDLType_ptr _v);
...
public:
  ...
  virtual void element_type_def(IDLType_ptr _v) = 0;
...
public:
  ...
  virtual void mode(AttributeMode _v) = 0;
...
public:
  ...
  void result_def(IDLType_ptr _v);
  ParDescriptionSeq* params();
  void params(const ParDescriptionSeq& _v);
  OperationMode mode();
  void mode(OperationMode _v);
  ContextIdSeq* contexts();
  void contexts(const ContextIdSeq& _v);
  ExceptionDefSeq* exceptions();
  void exceptions(const ExceptionDefSeq& _v);
...
public:
  ...
  virtual void result_def(IDLType_ptr _v) = 0;
  virtual ParDescriptionSeq* params() = 0;
  virtual void params(const ParDescriptionSeq& _v) = 0;
  virtual OperationMode mode() = 0;
  virtual void mode(OperationMode _v) = 0;
  virtual ContextIdSeq* contexts() = 0;
  virtual void contexts(const ContextIdSeq& _v) = 0;
  virtual ExceptionDefSeq* exceptions() = 0;
  virtual void exceptions(const ExceptionDefSeq& _v) = 0;
...
public:
  ...
  void base_interfaces(const InterfaceDefSeq& _v);
...
public:
  ...
  virtual void base_interfaces(const InterfaceDefSeq& _v) = 0;
...
public:
  ...
  virtual void access(Visibility _v) = 0;
...
public:
  ...
  void supported_interfaces(const InterfaceDefSeq& _v);
  InitializerSeq* initializers();
  void initializers(const InitializerSeq& _v);
  ValueDef_ptr base_value();
  void base_value(ValueDef_ptr _v);
  ValueDefSeq* abstract_base_values();
  void abstract_base_values(const ValueDefSeq& _v);
  ::CORBA::Boolean is_abstract();
...
public:
  ...
  virtual void supported_interfaces(const InterfaceDefSeq& _v) = 0;
  virtual InitializerSeq* initializers() = 0;
  virtual void initializers(const InitializerSeq& _v) = 0;
  virtual ValueDef_ptr base_value() = 0;
  virtual void base_value(ValueDef_ptr _v) = 0;
  virtual ValueDefSeq* abstract_base_values() = 0;
  virtual void abstract_base_values(const ValueDefSeq& _v) = 0;
