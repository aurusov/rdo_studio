...
protected:
	...
	// ƒл€ глобальный типов, напрмиер, дл€ параметров стандартных фыункций
...
// ----------------------------------------------------------------------------
// —начала цепл€етс€ к парсеру, а потом идет reparent на тип ресурса
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
// ---------- RDORTPDiap - Ўаблон классов диапазонов дл€ integer и real
// ----------------------------------------------------------------------------
// —начала цепл€етс€ к парсеру, а потом идет reparent на тип ресурса
// ----------------------------------------------------------------------------
template<class T>
...
public:
	RDORTPEnum* enu;
	std::string enum_name; // »спользуетс€ в сообщени€х об ошибках
	bool        enum_fun;  // »спользуетс€ в сообщени€х об ошибках
