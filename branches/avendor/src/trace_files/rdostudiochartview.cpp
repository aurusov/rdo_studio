...
int RDOStudioChartView::OnCreate( LPCREATESTRUCT lpCreateStruct )
{
	...
	if ( !previewMode )
		setStyle( &rdoTracerApp.mainFrame->style_chart, false );
	...
	popupMenu.AppendMenu( MF_SEPARATOR );
	appendMenu( mainMenu->GetSubMenu( 3 + delta ), 9, &popupMenu );
	appendMenu( mainMenu->GetSubMenu( 3 + delta ), 10, &popupMenu );
	appendMenu( mainMenu->GetSubMenu( 3 + delta ), 11, &popupMenu );
	appendMenu( mainMenu->GetSubMenu( 3 + delta ), 12, &popupMenu );
	popupMenu.AppendMenu( MF_SEPARATOR );
	appendMenu( mainMenu->GetSubMenu( 2 + delta ), 3, &popupMenu );
	popupMenu.AppendMenu( MF_SEPARATOR );
	appendMenu( mainMenu->GetSubMenu( 2 + delta ), 5, &popupMenu );
